...
public:
	...
	void MenuSetup(int32 NumOfPublicConnections = 4, FString TypeOfMatch = FString(TEXT("FreeForAll")), FString PathToLobby = FString(TEXT("/Game/ThirdPerson/Maps/Lobby")));
